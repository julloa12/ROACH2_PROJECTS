...
$ENV{'SYSGEN'} = '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen';
  ...
  $instrs = {
    ...
    'HDL_PATH' => '/home/ulloaroach2/design/test_adc2',
    'TEMP' => '/tmp',
    'TMP' => '/tmp',
    'Temp' => '/tmp',
    'Tmp' => '/tmp',
    ...
    'coregen_core_generation_tmpdir' => '/tmp/sysgentmp-ulloaroach2/cg_wk/cd6209778e28ad29b',
    ...
    'design' => 'snap2in',
    'design_full_path' => '/home/ulloaroach2/design/test_adc2/snap2in.slx',
    'device' => 'xc6vsx475t-1ff1759',
    'device_speed' => '-1',
    'directory' => '/home/ulloaroach2/design/test_adc2/snap2in/sysgen',
    'disregard_subsystem_handles' => [ 74993.00512695312, ],
    'dsp_cache_root_path' => '/tmp/sysgentmp-ulloaroach2',
    'fileDeliveryDefaults' => [
      [
        '(?i)\\.vhd$',
        { 'fileName' => '/home/ulloaroach2/design/test_adc2/snap2in/sysgen/sysgen/perl_results.vhd', },
      ],
      [
        '(?i)\\.v$',
        { 'fileName' => '/home/ulloaroach2/design/test_adc2/snap2in/sysgen/sysgen/perl_results.v', },
      ],
    ],
    'fxdptinstalled' => 1.0,
    'generateUsing71FrontEnd' => 1,
    'generating_island_subsystem_handle' => 74612.00061035156,
    'generating_subsystem_handle' => 74612.00061035156,
    ...
    'isdeployed' => 0,
    'ise_version' => '14.7i',
    'master_sysgen_token_handle' => 74613.34985351562,
    'matlab' => '/opt/MATLAB/R2013b',
    'matlab_fixedpoint' => 1.0,
    'mdlHandle' => 74612.00061035156,
    'mdlPath' => '/home/ulloaroach2/design/test_adc2/snap2in.mdl',
    'modelDiagnostics' => [
      {
        'count' => 493.0,
        'isMask' => 0.0,
    ...
    'model_path' => '/home/ulloaroach2/design/test_adc2/snap2in.mdl',
    ...
    'sg_version' => '',
    'simulation_island_subsystem_handle' => 74612.00061035156,
    ...
    'tempdir' => '/tmp',
    'testbench' => 0,
    'tmpDir' => '/home/ulloaroach2/design/test_adc2/snap2in/sysgen/sysgen',
    'trim_vbits' => 1.0,
    'use_strict_names' => 1,
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '49f1fdd934667bba1ef95a4111025090',
    'sourceFile' => '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xlslice.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '71c57d3c665df8a8755ed8d91c03021d',
    'sourceFile' => '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xlslice.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '40eb467bd35026de6c9b114dd57b617f',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'concat_dd8e77b436',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '3a797e2d592d1006cc71919709baf3c7',
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'bb53026ac4f426a5aca158cdc723c03a',
    'sourceFile' => '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '88b6556dbc613cfbc4235a0f8ebc4369',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
  ...
  signal cast_internal_ip_25_3_lsh: unsigned((21 - 1) downto 0);
  signal cast_internal_ip_36_3_convert: unsigned((11 - 1) downto 0);
begin
  ...
  cast_internal_ip_25_3_lsh <= u2u_cast(ip_1_23, 0, 21, 10);
  cast_internal_ip_36_3_convert <= u2u_cast(cast_internal_ip_25_3_lsh, 0, 11, 0);
  ...
  $instrs = [
    ...
    'CSET component_name = cntr_11_0_aa4bb8a7567a9dd3',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '824423c9ca2f231c0264375ab20df68f',
    ...
    'templateKeyValues' => {
      ...
      'entityName' => 'xlcounter_free_snap2in',
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'cc76c8648331c923844049547299adb9',
    'sourceFile' => '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xlslice.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'dded5611f9698521d2a69098786ebfab',
    'sourceFile' => '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xlslice.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => 'b7e6a6074f694801da0b09469eea1e9c',
    'sourceFile' => 'hdl/xlcounter_free.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      clk: in std_logic;
      ce: in std_logic;
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '597e97e8e7e9e69432da0e12e949a9cc',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '5b1082dae8f1c96f45f9f8f16a6d94df',
    'sourceFile' => '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xlslice.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '140d4b1ab665d8c26366257e76eefe69',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
  signal d_1_22: std_logic_vector((128 - 1) downto 0);
...
begin
  ...
  $instrs = [
    ...
    'CSET sync_threshold_output = false',
    'CSET syncctrlpriority = Reset_Overrides_Set',
    'CSET component_name = cntr_11_0_69db6e7c3b6d11cc',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '4d86eee60a267f179036fb53ea193331',
    'sourceFile' => 'hdl/xlcounter_free.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      clk: in std_logic;
      ce: in std_logic;
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '8bb1f6af4e09eb9b6ebf7ac6d1f9934e',
    'sourceFile' => '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xlconvert.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '79d7a4b17b44f1274370e1c35e6836fe',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'reinterpret_c07e1477bf',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '0de481f8933fc3262c228a6d10f0064f',
    'sourceFile' => '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xlregister.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '01f3ec8a8963b33b4038fe6adaf57745',
    'sourceFile' => 'hdl/xlcounter_free.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      clk: in std_logic;
      ce: in std_logic;
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen';
  open(RESULTS, '> /home/ulloaroach2/design/test_adc2/snap2in/sysgen/sysgen/script_results6508099155337427926') || 
    croak 'couldn\'t open /home/ulloaroach2/design/test_adc2/snap2in/sysgen/sysgen/script_results6508099155337427926';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing /home/ulloaroach2/design/test_adc2/snap2in/sysgen/sysgen/script_results6508099155337427926';
};
