...
$ENV{'SYSGEN'} = '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen';
  ...
  $instrs = {
    ...
    'HDL_PATH' => '/home/ulloaroach2/design/test_adc',
    'TEMP' => '/tmp',
    'TMP' => '/tmp',
    'Temp' => '/tmp',
    'Tmp' => '/tmp',
    ...
    'coregen_core_generation_tmpdir' => '/tmp/sysgentmp-ulloaroach2/cg_wk/c683b257d9b99fe70',
    ...
    'design' => 'snapshot_roach2',
    'design_full_path' => '/home/ulloaroach2/design/test_adc/snapshot_roach2.slx',
    'device' => 'xc6vsx475t-1ff1759',
    'device_speed' => '-1',
    'directory' => '/home/ulloaroach2/design/test_adc/snapshot_roach2/sysgen',
    'disregard_subsystem_handles' => [ 75189.00036621094, ],
    'dsp_cache_root_path' => '/tmp/sysgentmp-ulloaroach2',
    'fileDeliveryDefaults' => [
      [
        '(?i)\\.vhd$',
        { 'fileName' => '/home/ulloaroach2/design/test_adc/snapshot_roach2/sysgen/sysgen/perl_results.vhd', },
      ],
      [
        '(?i)\\.v$',
        { 'fileName' => '/home/ulloaroach2/design/test_adc/snapshot_roach2/sysgen/sysgen/perl_results.v', },
      ],
    ],
    'fxdptinstalled' => 1.0,
    'generateUsing71FrontEnd' => 1,
    'generating_island_subsystem_handle' => 74612.00036621094,
    'generating_subsystem_handle' => 74612.00036621094,
    'generation_directory' => './snapshot_roach2/sysgen',
    ...
    'isdeployed' => 0,
    'ise_version' => '14.7i',
    'master_sysgen_token_handle' => 74613.00036621094,
    'matlab' => '/opt/MATLAB/R2013b',
    'matlab_fixedpoint' => 1.0,
    'mdlHandle' => 74612.00036621094,
    'mdlPath' => '/home/ulloaroach2/design/test_adc/snapshot_roach2.mdl',
    'modelDiagnostics' => [
      {
        'count' => 561.0,
        'isMask' => 0.0,
        'type' => 'snapshot_roach2 Total blocks',
      },
      {
        'count' => 1.0,
        'isMask' => 0.0,
    ...
    'model_path' => '/home/ulloaroach2/design/test_adc/snapshot_roach2.mdl',
    ...
    'sg_version' => '',
    'simulation_island_subsystem_handle' => 74612.00036621094,
    ...
    'sysgenTokenSettings' => {
      ...
      'dcm_input_clock_period' => 100.0,
      'deprecated_control' => 'off',
      'directory' => './snapshot_roach2/sysgen',
      'impl_file' => 'ISE Defaults*',
      'incr_netlist' => 'off',
      'master_sysgen_token_handle' => 74613.00036621094,
      'ngc_config' => {
    ...
    'tempdir' => '/tmp',
    'testbench' => 0,
    'tmpDir' => '/home/ulloaroach2/design/test_adc/snapshot_roach2/sysgen/sysgen',
    'trim_vbits' => 1.0,
    'use_strict_names' => 1,
...
begin
  ...
  $instrs = {
    'entity_declaration_hash' => '0164a1f656415952752ada0582a6f3d3',
    ...
    'templateKeyValues' => {
      ...
      'entityName' => 'xlcounter_free_snapshot_roach2',
...
begin
  ...
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '48652d45616ed0457eeb31b4af5db619',
    'sourceFile' => 'hdl/xlcounter_free.vhd',
    'templateKeyValues' => {
      'core_component_def' => '      clk: in std_logic;
      ce: in std_logic;
...
begin
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen';
  open(RESULTS, '> /home/ulloaroach2/design/test_adc/snapshot_roach2/sysgen/sysgen/script_results8497283490253605706') || 
    croak 'couldn\'t open /home/ulloaroach2/design/test_adc/snapshot_roach2/sysgen/sysgen/script_results8497283490253605706';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing /home/ulloaroach2/design/test_adc/snapshot_roach2/sysgen/sysgen/script_results8497283490253605706';
};
