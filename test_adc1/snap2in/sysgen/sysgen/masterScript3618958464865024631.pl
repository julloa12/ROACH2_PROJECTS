...
$ENV{'SYSGEN'} = '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen';
  ...
  $instrs = {
    ...
    'disregard_subsystem_handles' => [ 76192.00122070312, ],
    'dsp_cache_root_path' => '/tmp/sysgentmp-ulloaroach2',
    'fileDeliveryDefaults' => [
      [
        '(?i)\\.vhd$',
        { 'fileName' => '/home/ulloaroach2/design/test_adc1/snap2in/sysgen/sysgen/perl_results.vhd', },
      ],
      [
        '(?i)\\.v$',
        { 'fileName' => '/home/ulloaroach2/design/test_adc1/snap2in/sysgen/sysgen/perl_results.v', },
      ],
    ],
    'fxdptinstalled' => 1.0,
    'generateUsing71FrontEnd' => 1,
    'generating_island_subsystem_handle' => 74612.00134277344,
    'generating_subsystem_handle' => 74612.00134277344,
    ...
    'isdeployed' => 0,
    'ise_version' => '14.7i',
    'master_sysgen_token_handle' => 74614.32153320312,
    'matlab' => '/opt/MATLAB/R2013b',
    'matlab_fixedpoint' => 1.0,
    'mdlHandle' => 74612.00134277344,
    ...
    'sg_version' => '',
    'simulation_island_subsystem_handle' => 74612.00134277344,
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'd4a4bc9b6c249ba6e1187ac21a3e7aaa',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  port (
    ...
    clr : in std_logic);
      ...
      'entity_name' => 'concat_350c391ba7',
    },
  };
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'e5dd44f2c4514e35914005b1559383fa',
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => 'da1cebaf459a98667720a33e765429f7',
    'sourceFile' => '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xldelay.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '3ddb657365ce3ff695ffaa0def00e662',
    'sourceFile' => 'hdl/xlmcode.vhd',
    'templateKeyValues' => {
      'crippled_architecture' => 'is
...
begin
  ...
  $instrs = [
    ...
    'CSET component_name = cntr_11_0_e9cde7997fd454dc',
    'GENERATE',
  ];
  push(@$results, &SgGenerateCores::saveXcoSequence($instrs));
  $instrs = {
    'entity_declaration_hash' => '020a0032a683c1dbf8c18e1af3650b35',
  ...
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '168380aed4e05fb69e2e63f8c7eb3752',
    'sourceFile' => '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xlslice.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => 'b35c2b81887a3d605e7f732ec914a371',
    'sourceFile' => '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xlslice.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
    'entity_declaration_hash' => '5196f7124476a0629b5b93652e62b080',
    'sourceFile' => '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xlslice.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '77302c0f0b7c62eebea2645734cf511e',
    'sourceFile' => '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xlconvert.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
begin
  ...
  push(@$results, &SgDeliverFile::deliverFile($instrs));
  $instrs = {
    'entity_declaration_hash' => '334dbbb1617a163d2eccef8a9b68e04b',
    'sourceFile' => '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen/hdl/xlslice.vhd',
  };
  push(@$results, &SgDeliverFile::saveCollaborationInfo($instrs));
  $instrs = {
...
begin
  ...
  use Carp qw(croak);
  $ENV{'SYSGEN'} = '/opt/Xilinx/14.7/ISE_DS/ISE/sysgen';
  open(RESULTS, '> /home/ulloaroach2/design/test_adc1/snap2in/sysgen/sysgen/script_results2745200262221276818') || 
    croak 'couldn\'t open /home/ulloaroach2/design/test_adc1/snap2in/sysgen/sysgen/script_results2745200262221276818';
  binmode(RESULTS);
  print RESULTS &Sg::toString($results) . "\n";
  close(RESULTS) || 
    croak 'trouble writing /home/ulloaroach2/design/test_adc1/snap2in/sysgen/sysgen/script_results2745200262221276818';
};
